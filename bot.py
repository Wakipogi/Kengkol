...
TOKEN = os.environ.get("8187468033:AAFKguJkrRoS_c858g2eGNCgksaXK9xuY_k")
MONGO_URI = os.environ.get("mongodb+srv://<Kenzu>:<kenzu15>@cluster0.u4hfdzb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
